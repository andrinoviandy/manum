<div class="modal-content">
    ...
    <form onsubmit="simpan_data_invoice('keuangan_invoice', {go:1, kas:'kas_pusat', cabang_id:1, id_proses: <?php echo $_POST['id_p'] ?>}); return false" id="formData">
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <script>
                    dropdown('dropdown_kas', 'kas', 'nama_kas', '', '', 'WHERE cabang_id = 1', 'required')
                </script>
            </div>
            <div class="form-group">
