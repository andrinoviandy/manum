    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">Ubah Penerimaan</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <script>
                                                dropdown('dropdown_kategori', 'kategori_keuangan', 'nama_kategori', <?php echo $row['kategori_keuangan_id']; ?>,'',"WHERE jenis_kategori = 'd' AND id != 4", 'required')
                                            </script>
                                        </div>
                                        <div class="form-group">
