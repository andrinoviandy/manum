                                ...
                                <div class="card-body row">
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <script>
                                                dropdownProses('dropdown_proses', <?php echo $row['proses_jamaah_id']; ?>, 'required')
                                            </script>
                                        </div>
                                        <div class="form-group">
                                            <label>Nomor</label>
                                            <input type="text" class="form-control" required name="no_invoice" value="<?php echo $row['nomor'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                    ...
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <script>
                                                dropdown('dropdown_kategori', 'kategori_keuangan', 'nama_kategori', <?php echo $row['kategori_keuangan_id']; ?>, '', "WHERE jenis_kategori = 'd'")
                                            </script>
                                        </div>
                                        <div class="form-group">
