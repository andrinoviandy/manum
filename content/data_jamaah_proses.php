    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">Proses Data Jamaah</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <section class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="card elevation-2" style="height: 300px;">
                                    ...
                                    <div class="card col-lg-4 table-responsive p-0" style="height: 300px; font-size: 12px;">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="float-right col-lg-10">
                                            <form onsubmit="simpan_data('proses_jamaah', 'on_progress'); return false" id="formData">
                                                <div class="form-group">
                                                    <label>Tanggal Proses <font color="red">*</font></label>
                                                    <input type="date" name="tgl_proses" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" name="jamaah_id" value="<?php echo $row['jamaah_id']; ?>">
                                                    <label>Pilih Paket</label>
                                                    <div id="dropdown_paket"></div>
                                                    <script>
                                                        dropdown('dropdown_paket', 'paket', 'nama_paket', '', '', "WHERE tayang = 1")
                                                    </script>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button class="btn btn-sm btn-success m-1" type="submit"><span class="fas fa-check-circle"></span> Proses</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
