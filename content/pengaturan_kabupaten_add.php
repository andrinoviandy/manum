    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">Tambah Kabupaten</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                ...
                                <div class="card-body row">
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <script>dropdown('dropdown_provinsi', 'provinsi', 'nama_provinsi','','','','required')</script>
                                        </div>
                                    </div>
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            <label>Nama Kabupaten <font color="red">*</font></label>
                                            <input type="text" class="form-control" required name="nama_kabupaten">
                                        </div>
                                    </div>
                                </div>
