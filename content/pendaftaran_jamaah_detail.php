    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">Detail Pendaftaran Jamaah</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <section class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <button onclick="loadContent(`${url}_edit`, <?php echo $row['id_p'] ?>);" class="btn btn-sm btn-info m-1"><span class="fas fa-edit"></span> Ubah</button>
                            </div>
                        </div>
                    </section>
                </div>
