    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">Tambah Akun Kas / Bank</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                ...
                                <div class="card-body row">
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required name="nama_kas">
                                        </div>
                                        <div class="form-group">
                                            <label>Pemilik <font color="red">*</font></label>
                                            <input type="text" class="form-control" required name="pemilik">
                                        </div>
                                    </div>
                                    <div class="card-body col-lg-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required name="no_rekening">
                                        </div>
                                    </div>
                                </div>
